...
public abstract class ClassValue<T> {
    ...
    // needs not to be ConcurrentHashMap because some recursive updates are made, CHH doesn't support that
    private static final Map<Class<?>, ClassValueMap> classValueMapCache = new HashMap<>();
    ...
    private static Entry<?>[] getCacheCarefully(Class<?> type) {
        ...
        ClassValueMap map = classValueMapCache.get(type);
    ...
    private static ClassValueMap getMap(Class<?> type) {
        ...
        ClassValueMap map = classValueMapCache.computeIfAbsent(type, ClassValue::initializeMap);
    ...
    private static ClassValueMap initializeMap(Class<?> type) {
        ...
        synchronized (CRITICAL_SECTION) {  // private object to avoid deadlocks
            ...
            map = classValueMapCache.computeIfAbsent(type, ClassValueMap::new);
        }
        return map;
    }
